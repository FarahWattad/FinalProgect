...
class _ProductsListScreen extends State<ProductsListScreen> {
  ...
  Future getProducts() async {
    var url = "products/getProducts.php?categoryID=1";
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                              child: ListTile(
                                ...
                                title: Text(project.productName!, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black),), // Icon(Icons.timer),
                                subtitle: Text(project.productPrice!.toString() + "שח", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black),),
                                // trailing: Container(
